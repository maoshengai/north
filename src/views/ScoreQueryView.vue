<template>
  <div style="padding:24px;">
    <a-form layout="inline" @submit.prevent="fetchScores">
      <a-form-item label="姓名">
        <a-input v-model="search.name" placeholder="支持模糊查询" />
      </a-form-item>
      <a-form-item label="学号">
        <a-input v-model="search.xh" placeholder="精确学号" />
      </a-form-item>
      <a-form-item label="科目">
        <a-input v-model="search.subject" placeholder="如 高等数学1-1" />
      </a-form-item>
      <a-form-item label="分数≥">
        <a-input-number v-model="search.min" />
      </a-form-item>
      <a-form-item label="分数≤">
        <a-input-number v-model="search.max" />
      </a-form-item>
      <a-form-item>
        <a-button type="primary" @click="fetchScores">查询</a-button>
      </a-form-item>
    </a-form>
